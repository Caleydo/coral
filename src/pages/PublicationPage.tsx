  ...
  return <div className="row">
    <div className="shadow-sm card p-2 overflow-hidden">
      <div className="card-body">
        <iframe className="mb-2" width="100%" height="100%" src="https://www.youtube-nocookie.com/embed/vSd3a9J63wQ?autoplay=0" frameBorder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowFullScreen></iframe>
      ...
      <div className="card-footer">
        <a href="https://academic.oup.com/bioinformatics/advance-article/doi/10.1093/bioinformatics/btab695/6384564?guestAccessKey=8b1777b2-4157-46ff-b5c2-0a69f1931cce" target="_blank" rel="noopener noreferrer" className="btn btn-light me-2"><i className="me-1 fas fa-globe-americas"></i> Publisher</a>
        <a href="https://academic.oup.com/bioinformatics/advance-article-pdf/doi/10.1093/bioinformatics/btab695/40532463/btab695.pdf?guestAccessKey=8b1777b2-4157-46ff-b5c2-0a69f1931cce" target="_blank" className="btn btn-light me-2"><i className="me-1 fas fa-file-pdf"></i> Download</a>
        <a href="https://github.com/Caleydo/Coral" target="_blank" rel="noopener noreferrer" className="btn btn-light"><i className="me-1 fab fa-github"></i> Source code</a>
      </div>
    </div>
  </div>;
}
                ...
                <div className="row">
                  <div className="col-12 col-xl-10 offset-xl-1 col-xxl-8 offset-xxl-2">
                    <p className="lead text-gray-600 pt-6">
                      Coral and its components have been described in the following scientific publications.<br />
