...
export const FORM_GENE_FILTER = {
    ...
    options: {
        ...
        uniqueKeys: true,
        badgeProvider: LineupUtils.previewFilterHint(gene.db, "gene", () => ({
            filter_species: SpeciesUtils.getSelectedSpecies(),
        })),
        entries: [
            {
                name: "Bio Type",
            ...
            },
            {
                ...
                optionsData: ValueCache.getInstance().cachedLazy(`${SpeciesUtils.getSelectedSpecies()}_gene_strands`, () => RestBaseUtils.getTDPData(gene.db, `gene_unique_all`, {
                    ...
                    name: `${d.text === -1 ? "reverse" : "forward"} strand`,
                    value: d.text,
                })))),
                options: {
                    placeholder: "Start typing...",
...
function generateFilter(d) {
    ...
    return {
        ...
        options: {
            ...
            badgeProvider: LineupUtils.previewFilterHint(d.db, d.base, () => ({
                filter_species: SpeciesUtils.getSelectedSpecies(),
            })),
            defaultSelection: false,
            uniqueKeys: true,
