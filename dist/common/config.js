...
export const cellline = {
    ...
    columns: (find) => {
        return [
            ...
            ColumnDescUtils.categoricalCol("organ", find("organ").categories, {
                label: "Organ",
            }),
            ColumnDescUtils.categoricalCol("gender", find("gender").categories, {
                label: "Gender",
            }),
...
export const tissue = {
    ...
    columns: (find) => {
        return [
            ...
            ColumnDescUtils.stringCol("tumortype_adjacent", {
                label: "Tumor Type adjacent",
                visible: false,
            }),
            ColumnDescUtils.categoricalCol("vendorname", find("vendorname").categories, { label: "Vendor name", visible: false }),
            ColumnDescUtils.categoricalCol("race", find("race").categories, {
                label: "Race",
                visible: false,
            }),
            ColumnDescUtils.categoricalCol("ethnicity", find("ethnicity").categories, { label: "Ethnicity", visible: false }),
            ColumnDescUtils.numberCol("age", find("age").min, find("age").max, {
                label: "Age",
                visible: false,
            }),
            ColumnDescUtils.numberCol("days_to_death", 0, find("days_to_death").max, {
                label: "Days to death",
                visible: false,
            }),
            ...
            ColumnDescUtils.numberCol("height", 0, find("height").max, {
                label: "Height",
                visible: false,
            }),
            ColumnDescUtils.numberCol("weight", 0, find("weight").max, {
                label: "Weight",
                visible: false,
            }),
            ColumnDescUtils.numberCol("bmi", 0, find("bmi").max, {
...
export const gene = {
    ...
    columns: (find) => {
        ...
        return [
            ...
            ColumnDescUtils.categoricalCol("biotype", find("biotype").categories, {
                label: "Biotype",
            }),
            ...
            ColumnDescUtils.numberCol("seqregionstart", 0, maxRegion, {
                label: "Seq Region Start",
                visible: false,
                extras: { renderer: "default" },
            }),
            ColumnDescUtils.numberCol("seqregionend", 0, maxRegion, {
                label: "Seq Region End",
                visible: false,
                extras: { renderer: "default" },
            }),
        ];
...
export function chooseDataSource(desc) {
    if (typeof desc === "object") {
        if (desc.sampleType === "Tissue" ||
            desc.idtype === "Tissue" ||
            desc.idType === "Tissue") {
            return tissue;
        }
        else if (desc.sampleType === "Cellline" ||
            desc.idtype === "Cellline" ||
            desc.idType === "Cellline") {
            return cellline;
        }
        else {
