...
export class RectangleLayout {
    ...
    setContainerGrid(container, columns, rows) {
        ...
        // calculate width
        const gridSizeString = gridStyleColumns.replace(/px/g, '');
        const gridSizeArray = gridSizeString.split(' ').map(Number);
    ...
    _getGridColumn(column) {
        return column === 1 ? column : column + (column - 1);
    }
    _assignSameRowForParentAndChild() {
...
//# sourceMappingURL=OverviewLayout.js.map